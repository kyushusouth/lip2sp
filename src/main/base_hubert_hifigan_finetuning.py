...
from src.pl_module.base_hubert_hifigan_finetuning import LitBaseHuBERTHiFiGANFineTuning
...
def main(cfg: omegaconf.DictConfig) -> None:
    ...
    if cfg["training"]["finetune"]:
        model = LitBaseHuBERTHiFiGANFineTuning.load_from_checkpoint(
            checkpoint_path=cfg["training"]["finetune_start_model_path"], cfg=cfg
        )
    else:
        model = LitBaseHuBERTHiFiGANFineTuning(cfg=cfg)
