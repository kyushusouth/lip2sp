...
from src.model.components.raven_utils.espnet.nets.pytorch_backend.ctc import CTC
from src.model.components.raven_utils.espnet.nets.pytorch_backend.nets_utils import (
    get_subsample,
    th_accuracy,
)
from src.model.components.raven_utils.espnet.nets.pytorch_backend.transformer.add_sos_eos import (
    add_sos_eos,
)
from src.model.components.raven_utils.espnet.nets.pytorch_backend.transformer.decoder import Decoder
from src.model.components.raven_utils.espnet.nets.pytorch_backend.transformer.encoder import Encoder
from src.model.components.raven_utils.espnet.nets.pytorch_backend.transformer.label_smoothing_loss import (
    LabelSmoothingLoss,  # noqa: H301
)
from src.model.components.raven_utils.espnet.nets.pytorch_backend.transformer.mask import target_mask
from src.model.components.raven_utils.espnet.nets.scorers.ctc import CTCPrefixScorer


class RAVEn(torch.nn.Module):
    def __init__(self, args, odim=1, ignore_id=-1):
        """Construct an RAVEn object.
